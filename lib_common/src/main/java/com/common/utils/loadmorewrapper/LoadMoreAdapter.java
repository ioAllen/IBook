package com.common.utils.loadmorewrapper;
...
public class LoadMoreAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_FOOTER) {
            ...
            View view = LoadMoreHelper.inflate(parent, R.layout.quick_view_load_more);
            view.findViewById(R.id.load_more_load_fail_view).setVisibility(View.GONE);
            view.findViewById(R.id.load_more_load_end_view).setVisibility(View.GONE);
            view.findViewById(R.id.load_more_loading_view).setVisibility(View.VISIBLE);
            ...
            View view = LoadMoreHelper.inflate(parent, R.layout.quick_view_load_more);
            view.findViewById(R.id.load_more_loading_view).setVisibility(View.GONE);
            view.findViewById(R.id.load_more_load_fail_view).setVisibility(View.GONE);
            view.findViewById(R.id.load_more_load_end_view).setVisibility(View.VISIBLE);
